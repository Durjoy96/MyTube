async function getVideos() {
    ...
    data.videos.forEach(item => {
        container.innerHTML += `<div class="w-full">
                <div class="w-full h-[200px] rounded-lg bg-cover bg-center" style="background-image: url('${item.thumbnail}')">
                </div>
                <div class="mt-5 flex gap-3">
                    ...
                    <div class="space-y-2">
                        ...
                        <span class="text-base text-gray-500">${item.others.views}</span>
                    </div>
                </div>
            </div>`;
    });
